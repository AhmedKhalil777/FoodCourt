using FoodCourt.Core.Interfaces;
using FoodCourt.Core.ProjectAggregate;
using FoodCourt.Core.ProjectAggregate.Events;
using FoodCourt.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace FoodCourt.UnitTests.Core.Handlers;
